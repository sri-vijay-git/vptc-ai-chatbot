                    ...
                    <div className="w-full max-w-3xl text-center space-y-8">
                        ...
                        <form onSubmit={handleSubmit} className="w-full">
                            <div className="relative group">
                                {/* RGB Animated Glow */}
                                <div className="absolute -inset-1.5 bg-gradient-to-r from-pink-500 via-purple-500 via-cyan-500 via-blue-500 to-pink-500 rounded-full blur-lg opacity-75 group-hover:opacity-100 transition-opacity duration-500 shadow-[0_0_20px_rgba(236,72,153,0.5)]"
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full px-6 sm:px-8 py-4 sm:py-5 text-sm sm:text-base md:text-lg rounded-full bg-white/80 dark:bg-[#2D1B15]/80 backdrop-blur-xl border border-white/50 dark:border-white/10 text-[#3E2723] dark:text-[#FFCC80] focus:outline-none relative z-10 transition-all shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] hover:shadow-[0_8px_32px_0_rgba(31,38,135,0.15)] pr-16"
                                    />
                                    <button
                                        type="submit"
                                        className="absolute right-2 top-1/2 -translate-y-1/2 p-3 bg-gradient-to-r from-[#8B6F47] to-[#6D563C] hover:from-[#6D563C] hover:to-[#5D4037] text-white rounded-full transition-all hover:scale-105 z-20 shadow-md"
                                    >
